 ...
 * `IRnsResultCallback` payload. Used for [network.libertychat.app.rns.api.RnsTransportAdmin.getDebugInfo]
 * and [network.libertychat.app.rns.api.RnsTransportAdmin.getInterfaceStats], whose
