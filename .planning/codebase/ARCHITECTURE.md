...
- Location: `app/src/main/java/network.libertychat.app/ui/`
...
- Location: `app/src/main/java/network.libertychat.app/viewmodel/`
...
- Location: `data/src/main/java/network.libertychat.app/data/repository/` and `app/src/main/java/network.libertychat.app/repository/`
...
- Location: `app/src/main/java/network.libertychat.app/service/`
...
- Location: `data/src/main/java/network.libertychat.app/data/db/`
...
- Location: `reticulum/src/main/java/network.libertychat.app/reticulum/`
...
- Location: `reticulum/src/main/java/network.libertychat.app/reticulum/model/` and `app/src/main/java/network.libertychat.app/data/model/`
...
- Examples: `reticulum/src/main/java/network.libertychat.app/reticulum/protocol/ReticulumProtocol.kt`
...
- Examples: `app/src/main/java/network.libertychat.app/service/binder/ReticulumServiceBinder.kt`
...
- One DAO per entity type in `data/src/main/java/network.libertychat.app/data/db/dao/`

## Entry Points

**MainActivity:**
- Location: `app/src/main/java/network.libertychat.app/MainActivity.kt`
...
**ColumbaApplication:**
- Location: `app/src/main/java/network.libertychat.app/ColumbaApplication.kt`
...
**ReticulumService:**
- Location: `app/src/main/java/network.libertychat.app/service/ReticulumService.kt`
...
- Location: `app/src/main/java/network.libertychat.app/service/RNodeCompanionService.kt`
...
- Location: `app/src/main/java/network.libertychat.app/util/validation/`
