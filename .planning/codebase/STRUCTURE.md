...
│   ├── src/
│   │   ├── main/
│   │   │   ├── java/network.libertychat.app/data/
...
│   ├── src/
│   │   ├── main/
│   │   │   ├── java/network.libertychat.app/reticulum/
...
│   ├── src/
│   │   └── main/kotlin/
│   │       └── network.libertychat.app/detekt/
│   └── build.gradle.kts
│
...
**Entry Points:**
- `app/src/main/java/network.libertychat.app/MainActivity.kt`: Main activity launcher
- `app/src/main/java/network.libertychat.app/ColumbaApplication.kt`: Application initialization
- `app/src/main/java/network.libertychat.app/service/ReticulumService.kt`: Background service
...
**Core Logic:**
- `data/src/main/java/network.libertychat.app/data/db/ColumbaDatabase.kt`: Database schema
- `app/src/main/java/network.libertychat.app/repository/`: Repository layer (conversations, identities, settings)
- `app/src/main/java/network.libertychat.app/service/manager/`: Service managers (messaging, health, BLE)
- `reticulum/src/main/java/network.libertychat.app/reticulum/protocol/ReticulumProtocol.kt`: Protocol contract
...
- `app/src/test/java/network.libertychat.app/test/`: Test fixtures and helpers
- Test fixture location: `app/src/test/java/network.libertychat.app/test/` (e.g., `BleTestFixtures.kt`)
...
**Directories:**
- Package structure mirrors domain: `network.libertychat.app.[feature]`
- Feature-specific packages group related code (e.g., `ui.screens.rnode`, `service.manager`)
- Test directories mirror source structure: `app/src/test/java/network.libertychat.app/[mirror-of-main]`

## Where to Add New Code

**New Feature (UI + Logic):**
- Primary code: `app/src/main/java/network.libertychat.app/ui/screens/[feature]/` for screens
- ViewModel: `app/src/main/java/network.libertychat.app/viewmodel/[Feature]ViewModel.kt`
- Repository: `data/src/main/java/network.libertychat.app/data/repository/[Feature]Repository.kt`
- Tests: Mirror structure under `app/src/test/java/` and `app/src/androidTest/java/`

**New Network Protocol Feature:**
- Implementation: `reticulum/src/main/java/network.libertychat.app/reticulum/[feature]/`
- Models: `reticulum/src/main/java/network.libertychat.app/reticulum/model/[Model].kt`
- Tests: `reticulum/src/test/java/network.libertychat.app/reticulum/[feature]/`

**New Component/Composable:**
- Implementation: `app/src/main/java/network.libertychat.app/ui/components/[ComponentName].kt`
- Models: `app/src/main/java/network.libertychat.app/ui/model/[ComponentModel].kt`

**Utilities:**
- Shared helpers: `app/src/main/java/network.libertychat.app/util/`
- Validation logic: `app/src/main/java/network.libertychat.app/util/validation/`
- Reticulum utilities: `reticulum/src/main/java/network.libertychat.app/reticulum/util/`

**Database Changes:**
- Entity: Add to `data/src/main/java/network.libertychat.app/data/db/entity/[EntityName].kt`
- DAO: Add to `data/src/main/java/network.libertychat.app/data/db/dao/[EntityName]Dao.kt`
- Migration: Add `MIGRATION_X_Y` in `data/src/main/java/network.libertychat.app/data/di/DatabaseModule.kt`
- Update: `ColumbaDatabase.version++`, add new entity to @Database annotation

**Service Managers (Background Process):**
- Manager: `app/src/main/java/network.libertychat.app/service/manager/[Feature]Manager.kt`
- Register: Add to `ServiceModule.createManagers()` in `app/src/main/java/network.libertychat.app/service/di/ServiceModule.kt`
