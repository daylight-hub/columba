...
- Integration: Python library + KotlinBLEBridge at `reticulum/src/main/java/network.libertychat.app/reticulum/ble/bridge/KotlinBLEBridge.kt`
...
- Usage: `LocationSharingManager` (`app/src/main/java/network.libertychat.app/service/LocationSharingManager.kt`) and `TelemetryCollectorManager` manage requests
...
- Usage: `MapScreen` at `app/src/main/java/network.libertychat.app/ui/screens/MapScreen.kt`
...
- `InterfaceDatabase` at `app/src/main/java/network.libertychat.app/data/database/InterfaceDatabase.kt` - Reticulum interface configs
- Core entities in `data/src/main/java/network.libertychat.app/data/db/entity/`:
