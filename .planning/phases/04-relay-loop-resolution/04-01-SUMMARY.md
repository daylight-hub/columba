...
key-files:
  created: []
  modified:
    - "app/src/main/java/network.libertychat.app/service/PropagationNodeManager.kt"
    - "app/src/test/java/network.libertychat.app/service/PropagationNodeManagerTest.kt"
...
- `app/src/main/java/network.libertychat.app/service/PropagationNodeManager.kt` - Changed SharingStarted.Eagerly to WhileSubscribed(5000L) for currentRelayState, currentRelay, availableRelaysState
- `app/src/test/java/network.libertychat.app/service/PropagationNodeManagerTest.kt` - Fixed 4 tests to use Turbine pattern for WhileSubscribed StateFlows
