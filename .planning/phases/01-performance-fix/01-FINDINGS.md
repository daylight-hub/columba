...
- `reticulum/src/main/java/network.libertychat.app/reticulum/python/PythonWrapperManager.kt` (Chaquopy lifecycle)
...
**Files to investigate:**
- `app/src/main/java/network.libertychat.app/ui/announce/AnnounceStreamScreen.kt`
- `app/src/main/java/network.libertychat.app/viewmodel/AnnounceStreamViewModel.kt`
...
- `reticulum/src/main/java/network.libertychat.app/reticulum/python/PythonWrapperManager.kt`
