...
key-files:
  created: []
  modified:
    - data/src/main/java/network.libertychat.app/data/db/dao/AnnounceDao.kt
    ...
    - app/src/main/java/network.libertychat.app/ui/screens/AnnounceStreamScreen.kt
...
- `data/src/main/java/network.libertychat.app/data/db/dao/AnnounceDao.kt` - Added deleteAllAnnouncesExceptContacts(identityHash) with SQL subquery
- `data/src/main/java/network.libertychat.app/data/repository/AnnounceRepository.kt` - Added repository passthrough method
- `app/src/main/java/network.libertychat.app/viewmodel/AnnounceStreamViewModel.kt` - Updated deleteAllAnnounces() to use identity-aware method with fallback
- `app/src/main/java/network.libertychat.app/ui/screens/AnnounceStreamScreen.kt` - Updated dialog text to mention contact preservation
