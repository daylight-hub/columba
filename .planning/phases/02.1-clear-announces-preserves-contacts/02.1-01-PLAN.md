...
must_haves:
  ...
  artifacts:
    - path: "data/src/main/java/network.libertychat.app/data/db/dao/AnnounceDao.kt"
    ...
    - path: "data/src/main/java/network.libertychat.app/data/repository/AnnounceRepository.kt"
      provides: "deleteAllAnnouncesExceptContacts(identityHash) passthrough"
      contains: "deleteAllAnnouncesExceptContacts"
    - path: "app/src/main/java/network.libertychat.app/viewmodel/AnnounceStreamViewModel.kt"
      provides: "Updated deleteAllAnnounces() with identity-aware routing"
      contains: "identityRepository.getActiveIdentitySync"
    - path: "app/src/main/java/network.libertychat.app/ui/screens/AnnounceStreamScreen.kt"
