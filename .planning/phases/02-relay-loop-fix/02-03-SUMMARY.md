...
- `app/src/test/java/network.libertychat.app/service/PropagationNodeManagerTest.kt` - Added 9 new test functions covering state machine lifecycle, state guards, and debounce behavior
...
- **Fix:** Changed to `MutableSharedFlow<List<network.libertychat.app.data.repository.Announce>>`
- **Files modified:** app/src/test/java/network.libertychat.app/service/PropagationNodeManagerTest.kt
