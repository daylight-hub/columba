...
- `app/src/main/java/network.libertychat.app/service/PropagationNodeManager.kt` - Added loop detection, exponential backoff, and Sentry diagnostics for relay selection
