...
import network.libertychat.app.rns.host.call.ServiceCallLifecycle
import network.libertychat.app.rns.backend.kt.CallPrivacyBridge
 ...
 * [network.libertychat.app.rns.api.RnsBackend] binding or the six sub-interface
 * extractors. Those moved to
 * [network.libertychat.app.rns.host.di.ProcessAwareBackendModule], which decides
 * per process whether to resolve this local backend (in `:reticulum`) or
 * return a [network.libertychat.app.rns.host.ipc.BoundRnsBackend] AIDL proxy
...
object HostBackendModule {
     ...
     * [ServiceSettingsAccessor] (provided by [network.libertychat.app.rns.host.di.PersistenceModule])
     ...
     * [network.libertychat.app.rns.host.di.ProcessAwareBackendModule].
     */
    @Provides
    @Singleton
    @LocalBackend
