...
import network.libertychat.app.rns.ipc.IRnsBackend
import network.libertychat.app.rns.ipc.RnsBackendClient
 ...
 * `null` so that [network.libertychat.app.rns.host.ipc.BoundRnsBackend]'s
 ...
 *
 * Consumed by [network.libertychat.app.rns.host.ipc.BoundRnsBackend] (A.10),
 ...
 * [network.libertychat.app.rns.host.di.ProcessAwareBackendModule] decides per
...
object ReticulumServiceConnection {
     ...
     */
    const val ACTION_BIND = "network.libertychat.app.rns.host.BIND"
