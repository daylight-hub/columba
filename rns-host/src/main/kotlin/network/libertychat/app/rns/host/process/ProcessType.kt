package network.libertychat.app.rns.host.process
 ...
 *
 * The dual-build runs the UI in `network.libertychat.app[.debug]` and the RNS stack in
 * `network.libertychat.app[.debug]:reticulum`. Both processes resolve the same
...
enum class ProcessType {
    /** Foreground UI process (`network.libertychat.app[.debug]`). */
    UI,
