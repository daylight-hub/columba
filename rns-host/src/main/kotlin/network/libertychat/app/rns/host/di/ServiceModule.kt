package network.libertychat.app.rns.host.di

import android.content.Context
import kotlinx.coroutines.CoroutineScope
import network.libertychat.app.rns.host.binder.ReticulumServiceBinder
import network.libertychat.app.rns.host.manager.BleCoordinator
import network.libertychat.app.rns.host.manager.CurrentTransport
import network.libertychat.app.rns.host.manager.LockManager
import network.libertychat.app.rns.host.manager.NetworkChangeManager
import network.libertychat.app.rns.host.manager.ServiceNotificationManager
import network.libertychat.app.rns.host.persistence.ServicePersistenceManager
import network.libertychat.app.rns.host.persistence.ServiceSettingsAccessor
import network.libertychat.app.rns.host.state.ServiceState
