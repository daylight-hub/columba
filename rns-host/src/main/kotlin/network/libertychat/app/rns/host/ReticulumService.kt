...
import network.libertychat.app.rns.host.di.ServiceModule
import network.libertychat.app.rns.host.persistence.BackendInitializer
import network.libertychat.app.rns.host.persistence.PeerActivityCollector
import network.libertychat.app.rns.host.rnode.KotlinRNodeBridge
import network.libertychat.app.rns.host.rnode.RNodeOnlineStatusListener
import network.libertychat.app.rns.host.usb.KotlinUSBBridge
import network.libertychat.app.rns.host.usb.UsbConnectionListener
import network.libertychat.app.rns.ipc.RnsBackendServer
...
class ReticulumService : Service() {
    companion object {
        ...
        const val ACTION_START = "network.libertychat.app.service.START"
        const val ACTION_STOP = "network.libertychat.app.service.STOP"
        const val ACTION_RESTART_BLE = "network.libertychat.app.RESTART_BLE"
        const val ACTION_UPDATE_NOTIFICATION = "network.libertychat.app.service.UPDATE_NOTIFICATION"
    ...
    override fun onCreate() {
        ...
        val isApplyingConfig =
            getSharedPreferences("libertychat_prefs", MODE_PRIVATE)
