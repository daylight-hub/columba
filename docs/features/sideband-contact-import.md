...
**File:** `data/src/main/java/network.libertychat.app/data/db/entity/ContactEntity.kt`
...
**File:** `app/src/main/java/network.libertychat.app/util/validation/InputValidator.kt`
...
**File:** `data/src/main/java/network.libertychat.app/data/repository/ContactRepository.kt`
...
**File:** `app/src/main/java/network.libertychat.app/viewmodel/ContactsViewModel.kt`
...
**File:** `reticulum/src/main/java/network.libertychat.app/reticulum/ReticulumService.kt`
...
**File:** `app/src/main/java/network.libertychat.app/ui/screens/ContactsScreen.kt`
...
**File:** `app/src/main/java/network.libertychat.app/service/IdentityResolutionWorker.kt` (new file)
...
import network.libertychat.app.reticulum.ReticulumService
...
**File:** `app/src/main/java/network.libertychat.app/ColumbaApplication.kt`
