...
├── micron/
│   ├── build.gradle.kts
│   └── src/main/java/network.libertychat.app/micron/
...
- **Columba MessageMapper:** `app/src/main/java/network.libertychat.app/ui/model/MessageMapper.kt`
- **Columba MessageUi:** `app/src/main/java/network.libertychat.app/ui/model/MessageUi.kt`
- **Columba MessagingScreen:** `app/src/main/java/network.libertychat.app/ui/screens/MessagingScreen.kt:434`
