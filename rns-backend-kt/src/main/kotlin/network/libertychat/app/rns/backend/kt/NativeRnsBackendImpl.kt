...
class NativeRnsBackendImpl(
    ...
    override suspend fun initialize(config: ReticulumConfig): Result<Unit> =
        withContext(Dispatchers.IO) {
            runCatching {
                ...
                if (network.libertychat.app.rns.api.util.SharedInstanceProbe.shouldShareInstance(config)) {
                    Log.w(
                        TAG,
    ...
    override suspend fun sendLocationTelemetry(
        ...
        fields[LxmfFields.FIELD_TELEMETRY] =
            network.libertychat.app.rns.api.util.TelemeterCodec.packLocationTelemetry(telemetry)
    ...
    override suspend fun sendTelemetryRequest(
        ...
        val timebaseSeconds =
            network.libertychat.app.rns.api.util.TelemeterCodec.telemetryRequestTimebaseSeconds(timebase)
        val commands =
            listOf(
                mapOf(
