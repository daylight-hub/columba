...
internal class NativeNomadNetHandler(
    ...
    ): Result<network.libertychat.app.rns.api.model.NomadnetPageResult> =
    ...
    private fun buildPageResult(
        ...
        metadata: ByteArray?,
        safePath: String,
    ): network.libertychat.app.rns.api.model.NomadnetPageResult {
        ...
        if (fileMeta != null) {
            ...
            return network.libertychat.app.rns.api.model.NomadnetPageResult(
                content = "",
                path = safePath,
                type = "file",
